...
Codex: PoS block must have mining reward paid to validatorAddress; EMA seed uses TargetBlockTimeSeconds when first block after genesis is PoS (not PoS interval from genesis).
